## Introduction 
Leveraging the advanced capabilities of Transformer architectures, traditionally renowned for their success in natural language processing (NLP), LiteFormer adapts this powerful mechanism to the time series forecasting domain, focusing on predicting the future closing prices of  S&P 500 stocks with high accuracy and efficiency at minimal computational power. 
